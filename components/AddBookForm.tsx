...
const AddBookForm: React.FC = () => {
  ...
  // If user is not admin, hide the form
  if (!isAdmin) {
    return null;
  }
  ...
  return (
    <div className="book-card group">
      <h2 className="book-card__content-title">Add book section</h2>
      ...
      {showNotification && (
        <div className="padding-x bg-primary-grey ">
          We are currently working on the Add Book section. Thank you for your
          patience.
        </div>
      )}
    </div>
